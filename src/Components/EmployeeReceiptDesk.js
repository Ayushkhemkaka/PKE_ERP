...
const EmployeeReceiptDesk = () => {
    ...
    const markPrinted = async (receipt) => {
        ...
        <section className='form-container'>
            <div className="page-heading">
                <div>
                    ...
                    <p className="page-subtitle mb-0">Every generated receipt from general and B2B orders appears here so the PK Enterprises team can preview and print it.</p>
                </div>
                <div className="page-badge">Print queue</div>
            </div>
